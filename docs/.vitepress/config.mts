...
export default defineConfig({
    ...
    description: 'Extension Manager is a convenient Laravel extension package designed for modular management of your large-scale Laravel applications. Each extension or addon acts as an independent Laravel application or microservice, allowing you to define your own views, controllers and models.',
    ...
    themeConfig: {
        ...
        footer: {
            ...
            copyright: 'Copyright © 2023 <a href="https://github.com/ife-adewunmi" target="_blank">Ifeoluwa Adewunmi</a>',
        },

        editLink: {
            pattern: 'https://github.com/ife-adewunmi/extension-manager/tree/main/docs/:path',
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/ife-adewunmi/extension-manager' }
        ]
    },
        ...
        'zh-Hans': {
            ...
            themeConfig: {
                ...
                footer: {
                    ...
                    copyright: 'Copyright © 2023 <a href="https://github.com/ife-adewunmi" target="_blank">唐杰</a>',
                },
